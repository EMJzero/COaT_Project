; ModuleID = '/tmp/tmp.py3MpcAXoU/test.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = sitofp i32 %.flt.fallback.s6_26fixp to float, !taffo.info !22, !taffo.target !25
  ...
  %.flt1 = load float, float* %arrayidx6.flt.s6_26fixp, align 4, !taffo.info !22, !taffo.initweight !26, !taffo.target !25
  %3 = fmul float 0x4190000000000000, %.flt1, !taffo.info !22, !taffo.target !25
  %.flt1.fallback.s6_26fixp = fptosi float %3 to i32, !taffo.info !22, !taffo.target !25
  %4 = sitofp i32 %.flt1.fallback.s6_26fixp to float, !taffo.info !22, !taffo.target !25
