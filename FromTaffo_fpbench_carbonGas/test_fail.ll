; ModuleID = '/tmp/tmp.0WtZ9eR2ns/test.ll.4.taffotmp.ll'
...
for.cond5:                                        ; preds = %for.inc21, %for.end
  %i4.0 = phi i32 [ 0, %for.end ], [ %inc22, %for.inc21 ], !taffo.info !13
...
for.cond8:                                        ; preds = %for.inc18, %for.body7
  %j.0 = phi i32 [ 0, %for.body7 ], [ %inc19, %for.inc18 ], !taffo.info !26
...
for.body10:                                       ; preds = %for.cond8
  ...
  %u1_31fixp = load i32, i32* %arrayidx15.u1_31fixp, align 4, !taffo.info !9, !taffo.target !12
  %1 = zext i64 -4337810866087919616 to i96
  %2 = shl i96 %1, 4
  %3 = zext i32 %u1_31fixp to i96, !taffo.info !9, !taffo.target !12
  ...
  %idxprom16 = sext i32 %j.0 to i64, !taffo.info !29
  %arrayidx17 = getelementptr inbounds float, float* %res, i64 %idxprom16
  store float %6, float* %arrayidx17, align 4, !taffo.info !39
  br label %for.inc18

for.inc18:                                        ; preds = %for.body10
  %inc19 = add nsw i32 %j.0, 1, !taffo.info !41, !taffo.constinfo !23
  br label %for.cond8, !llvm.loop !43

for.end20:                                        ; preds = %for.cond8
  br label %for.inc21

for.inc21:                                        ; preds = %for.end20
  %inc22 = add nsw i32 %i4.0, 1, !taffo.info !21, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !taffo.initweight !45 !taffo.funinfo !45 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %add = fadd float %conv, 0x3FCD70A3E0000000, !taffo.constinfo !46
...
for.end:                                          ; preds = %for.cond
  ...
  call void @test(float* noundef %arraydecay, float* noundef %arraydecay1), !taffo.constinfo !50
  ret i32 0
}
...
!40 = !{double 4.010140e+05, double 0x41E6D0CAC0200000}
!41 = !{i1 false, !42, i1 false, i2 0}
!42 = !{double 1.000000e+00, double 6.553600e+04}
!43 = distinct !{!43, !25}
!44 = distinct !{!44, !25}
!45 = !{}
!46 = !{i1 false, !47}
!47 = !{i1 false, !48, i1 false, i2 0}
!48 = !{double 0x3FCD70A3E0000000, double 0x3FCD70A3E0000000}
!49 = distinct !{!49, !25}
