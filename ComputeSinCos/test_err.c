...
void manual_cos(double * x_f, double * res_f)
{
    double x __attribute((annotate("target('x') scalar(range(0, 6.2831853))")));
    double res __attribute((annotate("errtarget('res') scalar(range(-1, 1))")));
