...
void mm(float * in_a __attribute((annotate("target('input_a') scalar(range(0, 256))"))),
    float * in_b __attribute((annotate("target('input_b') scalar(range(0, 256))"))),
    float * out_c __attribute((annotate("target('result_c') scalar()"))),
