; ModuleID = '/tmp/tmp.S0fA0tl0xR/test.ll.4.taffotmp.ll'
...
entry:
  %in_a.u9_23fixp = alloca [16384 x i32], align 16, !taffo.info !9, !taffo.target !12
  %in_b.u9_23fixp = alloca [16384 x i32], align 16, !taffo.info !9, !taffo.target !13
  %out_c.u38_26fixp = alloca [16384 x i64], align 16, !taffo.info !14, !taffo.target !17
  br label %for.cond

for.cond:                                         ; preds = %for.inc14, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc15, %for.inc14 ], !taffo.info !18
  %cmp = icmp slt i32 %i.0, 128, !taffo.info !20
...
for.cond7:                                        ; preds = %for.inc, %for.body
  ...
  %cmp8 = icmp slt i32 %j.0, 128, !taffo.info !20
  br i1 %cmp8, label %for.body9, label %for.end

for.body9:                                        ; preds = %for.cond7
  %mul = mul nsw i32 %i.0, 128, !taffo.info !24, !taffo.constinfo !26
  ...
  %mul10 = mul nsw i32 %i.0, 128, !taffo.info !24, !taffo.constinfo !26
  %add11 = add nsw i32 %mul10, %j.0, !taffo.info !27
  %idxprom12 = sext i32 %add11 to i64, !taffo.info !27
  %arrayidx13.u9_23fixp = getelementptr inbounds [16384 x i32], [16384 x i32]* %in_a.u9_23fixp, i64 0, i64 %idxprom12, !taffo.info !9, !taffo.target !12
...
for.cond17:                                       ; preds = %for.inc34, %for.end16
  ...
  %cmp18 = icmp slt i32 %i.1, 128, !taffo.info !20
...
for.cond20:                                       ; preds = %for.inc31, %for.body19
  ...
  %cmp21 = icmp slt i32 %j.1, 128, !taffo.info !20
  br i1 %cmp21, label %for.body22, label %for.end33

for.body22:                                       ; preds = %for.cond20
  %mul23 = mul nsw i32 %i.1, 128, !taffo.info !24, !taffo.constinfo !26
  ...
  %mul27 = mul nsw i32 %i.1, 128, !taffo.info !24, !taffo.constinfo !26
  %add28 = add nsw i32 %mul27, %j.1, !taffo.info !27
  %idxprom29 = sext i32 %add28 to i64, !taffo.info !27
  %arrayidx30.u9_23fixp = getelementptr inbounds [16384 x i32], [16384 x i32]* %in_b.u9_23fixp, i64 0, i64 %idxprom29, !taffo.info !9, !taffo.target !13
...
for.cond37:                                       ; preds = %for.inc66, %for.end36
  %sum.0.u38_26fixp = phi i64 [ 0, %for.end36 ], [ %sum.1.u38_26fixp, %for.inc66 ], !taffo.info !14
  %i.2 = phi i32 [ 0, %for.end36 ], [ %inc67, %for.inc66 ], !taffo.info !18
  %cmp38 = icmp slt i32 %i.2, 128, !taffo.info !20
...
for.cond40:                                       ; preds = %for.inc63, %for.body39
  %sum.1.u38_26fixp = phi i64 [ %sum.0.u38_26fixp, %for.body39 ], [ %sum.2.u38_26fixp, %for.inc63 ], !taffo.info !14
  %j.2 = phi i32 [ 0, %for.body39 ], [ %inc64, %for.inc63 ], !taffo.info !22
  %cmp41 = icmp slt i32 %j.2, 128, !taffo.info !20
...
for.cond43:                                       ; preds = %for.inc56, %for.body42
  %sum.2.u38_26fixp = phi i64 [ %sum.1.u38_26fixp, %for.body42 ], [ %add55.u38_26fixp, %for.inc56 ], !taffo.info !14
  %k.0 = phi i32 [ 0, %for.body42 ], [ %inc57, %for.inc56 ], !taffo.info !39
  %cmp44 = icmp slt i32 %k.0, 128, !taffo.info !20
  br i1 %cmp44, label %for.body45, label %for.end58

for.body45:                                       ; preds = %for.cond43
  %mul46 = mul nsw i32 %i.2, 128, !taffo.info !24, !taffo.constinfo !26
  %add47 = add nsw i32 %mul46, %k.0, !taffo.info !41
  %idxprom48 = sext i32 %add47 to i64, !taffo.info !41
  %arrayidx49.u9_23fixp = getelementptr inbounds [16384 x i32], [16384 x i32]* %in_a.u9_23fixp, i64 0, i64 %idxprom48, !taffo.info !9, !taffo.target !12
  %u9_23fixp = load i32, i32* %arrayidx49.u9_23fixp, align 4, !taffo.info !9, !taffo.target !12
  %mul50 = mul nsw i32 %k.0, 128, !taffo.info !43, !taffo.constinfo !26
  %add51 = add nsw i32 %mul50, %j.2, !taffo.info !45
  %idxprom52 = sext i32 %add51 to i64, !taffo.info !45
  %arrayidx53.u9_23fixp = getelementptr inbounds [16384 x i32], [16384 x i32]* %in_b.u9_23fixp, i64 0, i64 %idxprom52, !taffo.info !9, !taffo.target !13
  ...
  %11 = shl i64 %10, 11, !taffo.info !50
  %add55.u38_26fixp = add i64 %sum.2.u38_26fixp, %11, !taffo.info !14
  br label %for.inc56
...
for.end58:                                        ; preds = %for.cond43
  %mul59 = mul nsw i32 %i.2, 128, !taffo.info !24, !taffo.constinfo !26
  %add60 = add nsw i32 %mul59, %j.2, !taffo.info !27
  %idxprom61 = sext i32 %add60 to i64, !taffo.info !27
  %arrayidx62.u38_26fixp = getelementptr inbounds [16384 x i64], [16384 x i64]* %out_c.u38_26fixp, i64 0, i64 %idxprom61, !taffo.info !14, !taffo.target !17
  store i64 %sum.2.u38_26fixp, i64* %arrayidx62.u38_26fixp, align 4, !taffo.info !56, !taffo.target !17
  br label %for.inc63
...
for.cond69:                                       ; preds = %for.inc86, %for.end68
  ...
  %cmp70 = icmp slt i32 %i.3, 128, !taffo.info !20
...
for.cond72:                                       ; preds = %for.inc83, %for.body71
  ...
  %cmp73 = icmp slt i32 %j.3, 128, !taffo.info !20
  br i1 %cmp73, label %for.body74, label %for.end85

for.body74:                                       ; preds = %for.cond72
  %mul75 = mul nsw i32 %i.3, 128, !taffo.info !24, !taffo.constinfo !26
  %add76 = add nsw i32 %mul75, %j.3, !taffo.info !27
  %idxprom77 = sext i32 %add76 to i64, !taffo.info !27
  %arrayidx78.u38_26fixp = getelementptr inbounds [16384 x i64], [16384 x i64]* %out_c.u38_26fixp, i64 0, i64 %idxprom77, !taffo.info !14, !taffo.target !17
  %u38_26fixp = load i64, i64* %arrayidx78.u38_26fixp, align 4, !taffo.info !14, !taffo.target !17
  %12 = uitofp i64 %u38_26fixp to float, !taffo.info !14, !taffo.target !17
  %13 = fdiv float %12, 0x4190000000000000, !taffo.info !14, !taffo.target !17
  %mul79 = mul nsw i32 %i.3, 128, !taffo.info !24, !taffo.constinfo !26
...
entry:
  %in_a = alloca [16384 x float], align 16
  %in_b = alloca [16384 x float], align 16
  %out_c = alloca [16384 x float], align 16
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = mul nsw i32 %i.0, 128, !taffo.constinfo !26
  %add4 = add nsw i32 %mul, %j.0
  %idxprom = sext i32 %add4 to i64
  %arrayidx = getelementptr inbounds [16384 x float], [16384 x float]* %in_a, i64 0, i64 %idxprom
...
for.body15:                                       ; preds = %for.cond12
  ...
  %mul19 = mul nsw i32 %i.1, 128, !taffo.constinfo !26
  %add20 = add nsw i32 %mul19, %j.1
  %idxprom21 = sext i32 %add20 to i64
  %arrayidx22 = getelementptr inbounds [16384 x float], [16384 x float]* %in_b, i64 0, i64 %idxprom21
...
for.cond33:                                       ; preds = %for.inc43, %for.body32
  ...
  %cmp34 = icmp slt i32 %j.2, 128
  br i1 %cmp34, label %for.body36, label %for.end45

for.body36:                                       ; preds = %for.cond33
  %mul37 = mul nsw i32 %i.2, 128, !taffo.constinfo !26
  %add38 = add nsw i32 %mul37, %j.2
  %idxprom39 = sext i32 %add38 to i64
  %arrayidx40 = getelementptr inbounds [16384 x float], [16384 x float]* %in_a, i64 0, i64 %idxprom39
...
for.cond55:                                       ; preds = %for.inc65, %for.body54
  ...
  %cmp56 = icmp slt i32 %j.3, 128
  br i1 %cmp56, label %for.body58, label %for.end67

for.body58:                                       ; preds = %for.cond55
  %mul59 = mul nsw i32 %i.3, 128, !taffo.constinfo !26
  %add60 = add nsw i32 %mul59, %j.3
  %idxprom61 = sext i32 %add60 to i64
  %arrayidx62 = getelementptr inbounds [16384 x float], [16384 x float]* %in_b, i64 0, i64 %idxprom61
...
for.end71:                                        ; preds = %for.cond51
  %arraydecay = getelementptr inbounds [16384 x float], [16384 x float]* %in_a, i64 0, i64 0
  %arraydecay72 = getelementptr inbounds [16384 x float], [16384 x float]* %in_b, i64 0, i64 0
  %arraydecay73 = getelementptr inbounds [16384 x float], [16384 x float]* %out_c, i64 0, i64 0
...
for.cond79:                                       ; preds = %for.inc89, %for.body78
  ...
  %cmp80 = icmp slt i32 %j.4, 128
  br i1 %cmp80, label %for.body82, label %for.end91

for.body82:                                       ; preds = %for.cond79
  %mul83 = mul nsw i32 %i.4, 128, !taffo.constinfo !26
  %add84 = add nsw i32 %mul83, %j.4
  %idxprom85 = sext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds [16384 x float], [16384 x float]* %out_c, i64 0, i64 %idxprom85
...
!15 = !{!"fixp", i32 64, i32 26}
!16 = !{double 0.000000e+00, double 0x424060C080000000}
!17 = !{!"result_c"}
!18 = !{i1 false, !19, i1 false, i2 0}
!19 = !{double 0.000000e+00, double 1.290000e+02}
!20 = !{i1 false, !21, i1 false, i2 0}
!21 = !{double 0.000000e+00, double 1.000000e+00}
!22 = !{i1 false, !23, i1 false, i2 0}
!23 = !{double 0.000000e+00, double 1.664100e+04}
!24 = !{i1 false, !25, i1 false, i2 0}
!25 = !{double 0.000000e+00, double 1.638400e+04}
!26 = !{i1 false, i1 false}
!27 = !{i1 false, !28, i1 false, i2 0}
!28 = !{double 0.000000e+00, double 3.302400e+04}
!29 = !{i1 false, !11, i1 false, i2 1}
!30 = !{i1 false, !31, i1 false, i2 0}
!31 = !{double 1.000000e+00, double 1.664100e+04}
!32 = distinct !{!32, !33}
!33 = !{!"llvm.loop.mustprogress"}
!34 = !{i1 false, !35, i1 false, i2 0}
!35 = !{double 1.000000e+00, double 1.290000e+02}
!36 = distinct !{!36, !33}
!37 = distinct !{!37, !33}
!38 = distinct !{!38, !33}
!39 = !{i1 false, !40, i1 false, i2 0}
!40 = !{double 0.000000e+00, double 0x414060C080000000}
!41 = !{i1 false, !42, i1 false, i2 0}
!42 = !{double 0.000000e+00, double 0x414080C000000000}
!43 = !{i1 false, !44, i1 false, i2 0}
!44 = !{double 0.000000e+00, double 0x41B060C000000000}
!45 = !{i1 false, !46, i1 false, i2 0}
!46 = !{double 0.000000e+00, double 0x41B0610100000000}
...
!53 = !{double 1.000000e+00, double 0x414060C080000000}
